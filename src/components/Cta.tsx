...
// Generated: 2025-08-21T11:24:19.371Z
// Section: cta
// Category: cta
...
export default function BankProProductsCTA() {
  const stats = [
    { value: "10K+", label: "Businesses Served", icon: Users },
    { value: "99.99%", label: "Uptime Guarantee", icon: ShieldCheck },
    { value: "100+", label: "Banking Integrations", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary mb-8">
                ...
                Exclusive Offer for BankPro Customers
              </div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  BankPro's Banking Solutions
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Elevate your business with our cutting-edge banking platform. 
                Experience seamless integration, unparalleled security, and personalized support.
              </p>

              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                <Button size="lg" className="group text-base px-8 py-4">
                  Start Your BankPro Journey
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Enterprise-grade security and 99.99% uptime guarantee
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Easily connect your business with our extensive banking integrations
              </p>
            </div>
          </div>
        </div>
